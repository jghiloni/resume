...
\section{EXPERIENCE}
   ...
   \end{tabbing}\vspace{-10pt}
    ...
    For 2020, I have been leading the delivery of a small in-house SRE team as we pilot
...
\section{SKILLS}          
    ...
    {\bf CI/CD}: Concourse CI, Jenkins, Travis CI, CircleCI \\
    {\bf Monitoring \& Logging}: Prometheus, VMware Tanzu Observability by Wavefront,
    InfluxDB, Telegraf, Logstash, Grafana, Kibana, VMware LogInsight, Splunk, ElasticSearch
